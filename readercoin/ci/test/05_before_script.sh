...
if [ "$TRAVIS_OS_NAME" == "osx" ]; then
  echo > $HOME/Library/Application\ Support/Readercoin
else
  DOCKER_EXEC echo \> \$HOME/.readercoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/readercoin/readercoin/pull/18288#discussion_r433189350 for
  # details.
