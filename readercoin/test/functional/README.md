...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the ReadercoinTestFramework, place overrides for the
...
The [`TestShell`](test-shell.md) class exposes the ReadercoinTestFramework
...
Test objects for interacting with a readercoind node over the p2p interface.
