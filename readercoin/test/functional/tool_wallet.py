...
class ToolWalletTest(ReadercoinTestFramework):
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `readercoin-wallet help` raises an error. Use `readercoin-wallet -help`.
    ...
    def test_salvage(self):
        # TODO: Check salvage actually salvages and doesn't break things. https://github.com/readercoin/readercoin/issues/7463
