...
class P2PPermissionsTests(ReadercoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].readercoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].readercoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
