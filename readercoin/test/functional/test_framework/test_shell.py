...
class TestShell:
    """Wrapper Class for ReadercoinTestFramework.

    The TestShell class extends the ReadercoinTestFramework
    ...
    class __TestShell(ReadercoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ReadercoinTestFramework child class.
            self.num_nodes = 1
