...
# Copyright (c) 2010-2020 The Readercoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test objects for interacting with a readercoind node over the p2p protocol.

The P2PInterface objects interact with the readercoind nodes under test using the
