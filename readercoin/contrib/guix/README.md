# Bootstrappable Readercoin Core Builds

This directory contains the files necessary to perform bootstrappable Readercoin
Core builds.
...
- 24GB of free disk space on the partition that the Readercoin Core git repository
  resides in
...
For a Readercoin Core depends development environment, simply invoke
...
From the top of a clean Readercoin Core repository:
...
To use dongcarl's substitute server for Readercoin Core builds after having
