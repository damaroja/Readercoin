Readercoin Core version 0.16.3 is now available from:

  <https://readercoincore.org/bin/readercoin-core-0.16.3/>
...
been discovered in Readercoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` readercoinconsensus: invalid flags error should be set to `readercoinconsensus_err` (afk11)
