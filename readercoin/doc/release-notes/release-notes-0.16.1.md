Readercoin Core version 0.16.1 is now available from:

  <https://readercoincore.org/bin/readercoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting readercoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure readercoind processes are cleaned up when tests end (sdaftuar)
