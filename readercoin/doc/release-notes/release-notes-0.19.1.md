...
Readercoin Core version 0.19.1 is now available from:

  <https://readercoincore.org/bin/readercoin-core-0.19.1/>
...
From Readercoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Readercoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Readercoin Core does not yet change appearance when
...
- #17488 fix "readercoind already running" warnings on macOS (fanquake)
