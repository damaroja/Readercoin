Readercoin Core version *0.15.2* is now available from:

  <https://readercoincore.org/bin/readercoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in readercoin-tx (TheBlueMatt)
