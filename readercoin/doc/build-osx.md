...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Readercoin Core may be
...
The first time you run readercoind, it will start downloading the blockchain. This process could
