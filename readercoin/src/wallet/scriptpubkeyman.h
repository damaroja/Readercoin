...
#ifndef READERCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define READERCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Readercoin Core wallet was originally a collection of unrelated private
...
#endif // READERCOIN_WALLET_SCRIPTPUBKEYMAN_H
