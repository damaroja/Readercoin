...
#ifndef READERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define READERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@readercoin.
 *
 ...
 *
 * The chacha20-poly1305@readercoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@readercoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@readercoin are relatively fast in
...
#endif // READERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
