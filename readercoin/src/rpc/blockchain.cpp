                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of readercoin addresses",
                                    {{RPCResult::Type::STR, "address", "readercoin address"}}},
                            }},
...
UniValue dumptxoutset(const JSONRPCRequest& request)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/readercoin/readercoin/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
