    ...
    mapper(nullptr)
{
    ...
    ui->readercoinAtStartup->setToolTip(ui->readercoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->readercoinAtStartup->setText(ui->readercoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openReadercoinConfButton->setToolTip(ui->openReadercoinConfButton->toolTip().arg(PACKAGE_NAME));
