// Copyright (c) 2015-2020 The Readercoin Core developers
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_readercoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_readercoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_readercoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = ReadercoinUnits::formatWithUnit(unit, balance, false, ReadercoinUnits::SeparatorStyle::ALWAYS);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QCOMPARE(uri.count("readercoin:"), 2);
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_readercoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
