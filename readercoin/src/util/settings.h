...
#ifndef READERCOIN_UTIL_SETTINGS_H
#define READERCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/readercoin/readercoin/pull/15934/files#r337691812)
...
#endif // READERCOIN_UTIL_SETTINGS_H
