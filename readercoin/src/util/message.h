...
#ifndef READERCOIN_UTIL_MESSAGE_H
#define READERCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's readercoin address, it must refer to a public key.
...
#endif // READERCOIN_UTIL_MESSAGE_H
