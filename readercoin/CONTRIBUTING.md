...
First, in terms of structure, there is no particular concept of "Readercoin Core
...
Before you start contributing, familiarize yourself with the Readercoin Core build
system and tests. Refer to the documentation in the repository on how to build
Readercoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
[up for grabs](https://github.com/readercoin/readercoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Readercoin Core PR Review Club](https://readercoincore.reviews/) meeting.
...
For GUI-related issues or pull requests, the https://github.com/readercoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/readercoin/readercoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to readercoin-qt
...
fork of Readercoin Core copies the merge. Instead, make any username mentions in a
...
https://github.com/readercoin/readercoin/pull/16189).

Also see the [backport.py script](
https://github.com/readercoin-core/readercoin-maintainer-tools#backport).
